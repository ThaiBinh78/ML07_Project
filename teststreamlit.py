    ...
    if submitted:
        ...
        if not brand_data.empty:
            ...
            <div class="price-card {color}">
                <h2 class="text-white">{icon} {verdict}</h2>
            ...
            st.markdown("""
            <div class="custom-container">
                <h4 class="text-primary">📊 Thống kê thị trường</h4>
            """, unsafe_allow_html=True)
            ...
            st.markdown("""
            <div class="info-box">
                <h4 class="text-primary">💡 Khuyến nghị</h4>
            """, unsafe_allow_html=True)
...
# ----------------------
    ...
    st.markdown("""
    <div class="section-header">
        <h2 class="text-primary">📈 Báo Cáo & Thống Kê</h2>
        <p class="section-subheader">Phân tích dữ liệu và xu hướng thị trường</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab1:
        st.markdown('<h4 class="text-primary">Thống Kê Dữ Liệu Mẫu</h4>', unsafe_allow_html=True)
    ...
    with tab2:
        st.markdown('<h4 class="text-primary">Phân Tích Xu Hướng Giá</h4>', unsafe_allow_html=True)
    ...
    with tab3:
        st.markdown('<h4 class="text-primary">Feature Importance</h4>', unsafe_allow_html=True)
        try:
...
# ----------------------
    ...
    st.markdown("""
    <div class="section-header">
        <h2 class="text-primary">🛠️ Quản Trị Viên</h2>
        <p class="section-subheader">Quản lý submissions và hệ thống</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if admin_password == "admin123":  # In production, use secure password hashing
        ...
        with tab2:
            st.markdown('<h4 class="text-primary">Thông Tin Hệ Thống</h4>', unsafe_allow_html=True)
            col1, col2 = st.columns(2)
...
# ----------------------
    ...
    st.markdown("""
    <div class="section-header">
        <h2 class="text-primary">📋 Nhật Ký Hệ Thống</h2>
        <p class="section-subheader">Theo dõi lịch sử dự đoán và hoạt động</p>
    </div>
    """, unsafe_allow_html=True)
...
# ----------------------
    ...
    st.markdown("""
    <div class="section-header">
        <h2 class="text-primary">👨‍💻 Nhóm Thực Hiện</h2>
        <p class="section-subheader">Thông tin về nhóm phát triển dự án</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div style="text-align: center;">
            ...
            <h3 style="color: var(--text-color, #2c3e50); margin-bottom: 5px;">Nguyễn Thái Bình</h3>
            <p style="color: var(--secondary-text-color, #7f8c8d); margin: 0;">Data Scientist & Developer</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="custom-form">
            ...
            <p class="text-secondary"><strong>📧 Email:</strong> thaibinh782k1@gmail.com</p>
            <p class="text-secondary"><strong>🐙 GitHub:</strong> <a href="https://github.com/ThaiBinh78/ML07_Project" target="_blank" style="color: var(--text-color, #2c3e50);">ThaiBinh78/ML07_Project</a></p>
            <p class="text-secondary"><strong>📅 Ngày báo cáo:</strong> 22/11/2024</p>
            
            <h4 class="text-primary" style="margin-top: 20px;">🛠 Công Nghệ Sử Dụng</h4>
            <p class="text-secondary">• Python, Streamlit, Scikit-learn</p>
            <p class="text-secondary">• Pandas, NumPy, Matplotlib</p>
            <p class="text-secondary">• Random Forest, Isolation Forest</p>
            <p class="text-secondary">• Machine Learning, Data Analysis</p>
        </div>
        """, unsafe_allow_html=True)
    
    st.markdown("---")
    st.markdown("""
    <div style="text-align: center; color: var(--secondary-text-color, #7f8c8d); padding: 20px;">
...
# ----------------------
st.markdown("""
<div style="text-align: center; color: var(--secondary-text-color, #7f8c8d); padding: 40px 0 20px 0;">
    <hr style="border-color: var(--border-color, #e0e6ed); margin-bottom: 20px;">
